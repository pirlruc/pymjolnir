...
### 2026-05-27 (UTC) — Harden manual PyPI publish tag handling

**Trigger:** Cron bug-finding automation inspected recent commits for critical correctness or security
issues.
